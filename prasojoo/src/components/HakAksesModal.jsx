    ...
    <div className="fixed inset-0 bg-black/50 flex justify-center items-center z-50">
      <div className="bg-white p-6 rounded-lg shadow-xl w-96">
        ...
        <form autoComplete="off" className="space-y-3">
          {/* NAMA */}
          <div>
            <label className="text-sm">Nama <span className="text-red-500">*</span>
            </label>
            <input
              type="text"
              value={form.nama}
          ...
          {/* USERNAME */}
          <div>
            <label className="text-sm">Username <span className="text-red-500">*</span>
            </label>
            <input
              type="text"
              value={form.username}
          ...
          {/* EMAIL */}
          <div>
            <label className="text-sm">Email <span className="text-red-500">*</span>
            </label>
            <input
              type="email"
              value={form.email}
