export default function KasTable({ data, onEdit, onDelete, sortBy, sortDir, onToggleSortTanggal, totalPemasukan, totalPengeluaran, saldoAkhir }) {
  return (
